export const StepOneIllo = () => {
  return (
    <div className="step-illo self-start h-full w-auto md:px-60 flex items-center justify-center">
      <svg className="absolute h-full w-auto top-0 left-1/2 -translate-x-1/2" width="1015" height="1016" viewBox="0 0 1015 1016" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Circle 1 */}
