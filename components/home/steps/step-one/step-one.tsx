...
export const StepOne: FC<StepOneProps> = ({ title, description }) => {
  ...
  return (
    <section className="flex-1 flex flex-col items-center gap-y-24 md:gap-y-0" ref={stepOneRef}>
      <StepDetails
        step={1}
        title={title}
        description={description}
        icon={(
          <div className="step-icon relative z-[10] w-64 h-64 md:h-[clamp(60px,4.25vw,80px)] md:w-[clamp(60px,4.25vw,80px)]">
            <IconStepOne
              highlight
