export const StepThreeIllo = () => {
  return (
    <div className="step-illo absolute w-full h-full inset-0 px-60 flex justify-center z-[1]">
      <svg className="h-full w-auto relative z-[1]" width="1207" height="1060" viewBox="0 0 1207 1060" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Left Box */}
