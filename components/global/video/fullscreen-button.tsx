...
export const FullscreenButton: FC<FullscreenButtonProps> = (rest) => {
  return (
    <button className="cursor-pointer w-20 h-20 md:w-24 md:h-24 flex-center text-white all-interactions:text-step-200 transition-colors duration-400 ease" {...rest}>
